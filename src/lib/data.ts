...
export const DEALS: Deal[] = [
  {
    ...
    riskScoreTrend: "up",
    riskLevel: "high",
    aiInsight: "Score increased due to lack of recent activity.",
    rootCauses: [
  ...
  },
  {
    ...
    riskScoreTrend: "down",
    riskLevel: "medium",
    aiInsight: "Score improved after addressing integration concerns.",
    rootCauses: [
  ...
  },
  {
    ...
    riskLevel: "low",
    aiInsight: "Score stable, pending pricing discussion outcome.",
    rootCauses: [
  ...
  },
  {
    ...
    riskScoreTrend: "down",
    riskLevel: "low",
    aiInsight: "Score improved after strong champion was identified.",
    rootCauses: [
  ...
  },
  {
    ...
    riskScoreTrend: "up",
    riskLevel: "high",
    aiInsight: "Score increased, demo has been delayed 3 times.",
    rootCauses: [
  ...
  },
  {
    ...
    riskScoreTrend: "up",
    riskLevel: "medium",
    aiInsight: "Score increased due to legal review delay.",
    rootCauses: [
  ...
  },
  {
    ...
    riskScoreTrend: "down",
    riskLevel: "low",
    aiInsight: "Score improved due to active VP engagement.",
    rootCauses: [
  ...
  },
  {
    ...
    riskScoreTrend: "up",
    riskLevel: "medium",
    aiInsight: "Score increased, compliance concerns raised.",
    rootCauses: [
  ...
  },
  {
    ...
    riskScoreTrend: "stable",
    riskLevel: "medium",
    aiInsight: "Score stable, awaiting outcome of discount request.",
    rootCauses: [
  ...
  },
  {
    ...
    riskScoreTrend: "up",
    riskLevel: "high",
    aiInsight: "Score increased sharply, champion left company.",
    rootCauses: [
  ...
  },
  {
    ...
    riskScoreTrend: "down",
    riskLevel: "low",
    aiInsight: "Score improved, demo was successful.",
    rootCauses: [
  ...
  },
  {
    ...
    riskScoreTrend: "up",
    riskLevel: "medium",
    aiInsight: "Score increased slightly, contract is stalled.",
    rootCauses: [
